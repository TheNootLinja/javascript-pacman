...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    key: "showGameStatus",
    value: function showGameStatus(winCon) {
      var div = document.createElement('div');
      div.classList.add('game-status');
      div.innerHTML = "".concat(winCon ? 'YOU WON!' : 'GAME OVER');
...
//Classes
// DOM Elements
var gridGame = document.querySelector('#game');
var gameScore = document.querySelector('#score');
var gameStart = document.querySelector('#start-button'); // Game Constants

var POWER_PILL_TIME = 10000;
var GLOBAL_SPEED = 80;

var gameBoard = _GameBoard.default.createGameBoard(gridGame, _setup.LEVEL); // Initial Setup
...
function startGame() {}
},{"./setup.js":"setup.js","./GameBoard":"GameBoard.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/javascript-pacman.e31bb0bc.js.map